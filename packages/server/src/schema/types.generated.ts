...
export type ResolversParentTypes = {
  ...
  ID: Scalars['ID'];
  Query: {};
  Question: ResolversParentTypes['SelectQuestion'] | ResolversParentTypes['TextQuestion'];
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  createForm?: Resolver<Maybe<ResolversTypes['Questionnaire']>, ParentType, ContextType, RequireFields<MutationCreateFormArgs, 'form'>>;
  createQuestion?: Resolver<Maybe<ResolversTypes['Question']>, ParentType, ContextType, RequireFields<MutationCreateQuestionArgs, 'formId' | 'question'>>;
};
...
export type QuestionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Question'] = ResolversParentTypes['Question']> = {
  __resolveType: TypeResolveFn<'SelectQuestion' | 'TextQuestion', ParentType, ContextType>;
...
export type SelectQuestionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SelectQuestion'] = ResolversParentTypes['SelectQuestion']> = {
  _id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
